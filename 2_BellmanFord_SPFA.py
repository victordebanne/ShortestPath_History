"""
evolution de l'algorithme de Bellman-Ford par propagation à partir du point d'arrivée
(complexité divisée par 2) (SPFA)
"""
...
class Network():
    ...
    def find_path(self):
        ...
        to_do_list = [self.nodes[0]]
        while to_do_list != [] : 
            #on se concentre sur le node en haut de la to_do_list
            current = to_do_list[0]
            ...
            for i in range(len(current.links)):
                ...
                if dist_to_neighbor + current_to_B < neighbor_to_B :
                    ...
                    to_do_list.append(current.links[i])
